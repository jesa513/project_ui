        ...
        return (
            <div onClick={this.onItemClick} className={`col-md-${this.props.size} col-sm-6 portfolio-item`}>
                <div className="portfolio-link" data-toggle="modal">
                    ...
                    <img src={`http://localhost:1997${image}`} alt={productname} />
                    {/* <img src={`http://localhost:1997${image}`} alt={productname} width={100}/> */}
                </div>
...
export default connect(null, { select_product })(EquipmentItem);